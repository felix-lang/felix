# -*- coding: utf-8 -*-
#
# felix documentation build configuration file
#
...
man_pages = [
    ('index', 'felix-library', u'Felix Library',
     [u'John Skaller'], 1)
]
...
texinfo_documents = [
  ('index', 'felix', u'Felix Documentation',
   u'John Skaller', 'felix-library', 'Felix library packages',
   'Miscellaneous'),
]
