...
syntax cbind {
  ...
  //$ gen _ctor_RE2 : string -> RE2 = "new (*PTF gcp, @0@,@ @f@a@l@s@e@)@ @R@E@2@(@$@1@)@"@;
  //$
  ...
  //$ _gc_type RE2_ does. This allows the notation @0@ @t@o@ @r@e@f@e@r@ @t@o
...
//------------------------------------------------------------------------
  ...
  //$ C pointer type.
  x[sthename_pri] :=  "@"@ @x@[@s@t@h@e@n@a@m@e@_@p@r@i@]@ @=@>@#@ @"@(@P@r@e@f@i@x@)@"@;
