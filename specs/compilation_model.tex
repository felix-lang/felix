...
the print statement. (However Python 3 is required to actually
build the system).
...
If \verb%--list% is specified, the names of packages actually found
are printed.
...
The best way to understand \verb%flx_pkgconfig% is that it performs
a recursive descent of a dependency tree, printing the values of
a specified attribute as it encounters them, thus forming a transitive
