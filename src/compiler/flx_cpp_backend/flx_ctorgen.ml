...
let gen_ctor syms sym_table bsym_table name display funs extra_args extra_inits ts props =
  ...
  (
    ...
    map
    (
      fun (i,vslen) -> let instname = cpp_instance_name syms sym_table bsym_table i (list_prefix ts vslen) in
