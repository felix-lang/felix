...
= 
  ...
  | BBDCL_fun (props,_,_,BTYP_void,effects,exes) ->
    ...
    *)
    ...
    | BEXE_init (sr,_,(_,t))
    | BEXE_assign (sr,_,(_,t))

    (* ER ... but this one does involve pointers ..? *)
