...
\subsection{The {\tt return from} statement}
This statement is a variant of the \verb%return% statement which
causes the resumption of the continuation passed to the most recent
activation of an ancestor procedure. The transfer of control may
not span a function call. 
