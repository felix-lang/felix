...
\subsection{Top down fold}
This fold processes the element at
the parent before the children:
...
\section{Zippers}
For any inductive data type, there is a related type known as a zipper.
