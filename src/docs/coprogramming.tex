...
is undefined, or \verb%Some v% is it is, and the result would be \verb%v%.
...
It is conventional to use an infix operator for \verb%bind%
which we provide by a user defined syntax extension:

\begin{minted}[bgcolor=felxbg]{felix}
...
We can define the option monad:
