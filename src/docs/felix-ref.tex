...
\section{goto-indirect/label\_address}
...
Note that the argument of the typecase is an expression,
the result of each is a branch dependent on the type of the 
expression. Although primarily of use in generic functions, 
