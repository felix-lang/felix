...
For each scope, another hash table called a {\em name lookup table}
...
Typeset constraints are actually a special case of the more general
form of a constraint which may be any evaluable predicate on any
type expression possibly involving one or more type variables.
