...
Rather, a variable {\em IS} an address, and the spelling
...
\begin{minted}{felix}
  int * int -> int      // type of RHS projection function
  &(int * int) -> &int  // type of LHS projection function
\end{minted}
...
\section{read/write/broadcast schannel}
