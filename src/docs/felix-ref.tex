...
There is a table of the operators \ref{Int Operators}.

\begin{table}
\caption{Int Operators}
\label{Int Operators}
\centering
\begin{tabular}[c]{lll}
\hline
...
\hline
\hline
\verb%==%&\verb%int * int -> bool%&equality\\
\verb%!=%&\verb%int * int -> bool%&inequality\\
\hline
\verb%<%&\verb%int * int -> bool%&less\\
\verb%<=%&\verb%int * int -> bool%&less or equal\\
\verb%>%&\verb%int * int -> bool%&greater\\
\verb%>=%&\verb%int * int -> bool%&greater or equal\\
\hline
\verb%+%&\verb%int * int -> int%&addition\\
\hline
\verb%-%&\verb%int * int -> int%&subtraction\\
\hline
\verb%*%&\verb%int * int -> int%&multiplication\\
\hline
\verb%/%&\verb%int * int -> int%&quotient\\
\verb+%+&\verb%int * int -> int%&remainder\\
\hline
\verb%<<%&\verb%int * int -> int%&multiplication by power of 2\\
\verb%>>%&\verb%int * int -> int%&division by power of 2\\
\hline
\verb%-%&\verb%int -> int%&negation\\
\end{tabular}
\end{table}
