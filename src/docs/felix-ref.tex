...
\hline
\verb%connect%&Client&Faio_posix\\
\verb%accept%&Server&Faio_posix\\
\verb%async_rw%&Client and Server&Faio_posix\\
\verb%async_read%&Client and Server&Faio_posix\\
\verb%async_write%&Client and Server&Faio_posix\\
\verb%Connect%&Client&Faio_win32\\
\verb%Accept%&Server&Faio_win32\\
\verb%WSARecv%&Client and Server&Faio_win32\\
\verb%WSASend%&Client and Server&Faio_win32\\
\verb%TransmitFile%&Client and Server&Faio_win32\\
\multicolumn{3}{c}{Platform Independent}\\
\verb%connect%&Client&Socket\\
\verb%accept%&Server&Socket\\
\verb%read%&Server&Socket\\
\verb%write%&Server&Socket\\
\hline
