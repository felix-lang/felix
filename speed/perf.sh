...
echo "Felix" >&2
echo "Felix"
build/release/host/bin/flx --felix=build.fpc --usage=hyperlight -O2 -c --static -o sandbox/flx-ack speed/ack/felix/test.flx && time sandbox/flx-ack
echo "clang" >&2
echo "clang"
...
echo "Felix" >&2
echo "Felix"
build/release/host/bin/flx --felix=build.fpc --usage=hyperlight -O2 -c --static -o sandbox/flx-takfp speed/takfp/felix/test.flx && time sandbox/flx-takfp
echo "clang" >&2
echo "clang"
...
echo "Felix" >&2
echo "Felix"
build/release/host/bin/flx --felix=build.fpc --usage=hyperlight -O2 -c --static -o sandbox/flx-nbody speed/nbody/felix/test.flx && time sandbox/flx-nbody
echo "clang" >&2
echo "clang"
...
echo "Felix" >&2
echo "Felix"
build/release/host/bin/flx --felix=build.fpc --usage=hyperlight -O2 -c --static -o sandbox/flx-mandelbrot speed/mandelbrot/felix/test.flx && time sandbox/flx-mandelbrot
echo "clang++" >&2
echo "clang++"
...
echo "Felix" >&2
echo "Felix"
build/release/host/bin/flx --felix=build.fpc --usage=hyperlight -O2 -c --static -o sandbox/flx-mandelbrot21 speed/mandelbrot21/felix/test.flx && time sandbox/flx-mandelbrot21
echo "clang++" >&2
echo "clang++"
...
echo "Felix" >&2
echo "Felix"
build/release/host/bin/flx --felix=build.fpc --usage=hyperlight -O2 -c --static -o sandbox/flx-spectralnorm speed/spectralnorm/felix/test.flx && time sandbox/flx-spectralnorm
echo "clang" >&2
echo "clang"
